...
import org.raphael.com.dto.BoardColumnInfoDTO;
import org.raphael.com.exception.CardBlockedException;
import org.raphael.com.exception.CardFinishedException;
import org.raphael.com.exception.EntityNotFoundException;
import org.raphael.com.persistence.dao.BlockDAO;
import org.raphael.com.persistence.dao.CardDAO;
import org.raphael.com.persistence.entity.BoardColumnKindEnum;
import org.raphael.com.persistence.entity.CardEntity;

import java.sql.Connection;
import java.sql.SQLException;
import java.util.List;

import static org.raphael.com.persistence.entity.BoardColumnKindEnum.CANCEL;
import static org.raphael.com.persistence.entity.BoardColumnKindEnum.FINAL;
...
public class CardService {
    ...
    public void cancel (final Long cardId, final Long cancelColumnId,
                        final List<BoardColumnInfoDTO> boardColuimnsInfo) throws SQLException {
        try {
            var dao = new CardDAO(connection);
            var optional = dao.findById(cardId);
            var dto = optional.orElseThrow(
            ...
            var currentColumn = boardColuimnsInfo.stream()
                    .filter( bc -> bc.id().equals(dto.columnId()))
                    .findFirst()
                    .orElseThrow( () -> new IllegalStateException("O card informado pertence a outro board"));
            if (currentColumn.kind().equals(FINAL)) {
